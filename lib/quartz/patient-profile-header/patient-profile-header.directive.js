...
/**
 * @ngdoc directive
 * @name qdPatientProfileHeader
 * @module qz.directives.patient-profile-header
 * @restrict E
 * @description
 * `qdPatientProfileHeaderDirective` is used to display a patient profile header.
 ...
 *
 */
function qdPatientProfileHeaderDirective(){
  var directive = {
    scope: {
      'patient': '=',
      'hiddenFields': '=?',
    ...
    template: require('./patient-profile-header.html'),
    restrict: 'E',
    bindToController: true,
    controller: qdPatientProfileHeaderController.qdPatientProfileHeaderController,
    controllerAs: 'vm'
  };
  return directive;
}

exports.qdPatientProfileHeaderDirective = qdPatientProfileHeaderDirective;