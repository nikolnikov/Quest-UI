'use strict';
qdPatientProfileCardController.$inject = ['$log', '$mdDialog', '$mdMedia'];
/* @ngInject */
function qdPatientProfileCardController($log, $mdDialog, $mdMedia) {
    var vm = this;
...
exports.qdPatientProfileCardController = qdPatientProfileCardController;
